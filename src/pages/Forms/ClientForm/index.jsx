    ...
    <main className="client-form">
      ...
      <form id="client-form-container" onSubmit={formik.handleSubmit}>
        ...
        <section id="agendamento">
          ...
          <input
            {...register("agendamentoFimDeSemana")}
            onChange={formik.handleChange}
            id="agendamento-sim"
            type="radio"
            value="Sim"
          ...
          <div>
            <ul type="none">
              ...
              <li>
                ...
                <LabelServ
                  id="indic-estabelecimento"
                  label="Estabelecimento conveniado"
                />
              </li>
