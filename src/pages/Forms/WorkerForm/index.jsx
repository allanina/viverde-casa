...
export default function WorkerForm() {
  ...
  const workerSchema = Yup.object().shape({
    ...
    endereco: Yup.string().required("O logadouro é obrigatório."),
    ...
    portDeficiencia: Yup.string().required("Selecione uma opção."),
    tipoDeficiencia: Yup.array(),
    possuiCnpj: Yup.string().required("Selecione uma opção."),
    ...
    cobraServico: Yup.string().required("Selecione uma opção."),
    precoMedio: Yup.string().required("Informe o preço médio do serviço."),
    contato1: Yup.string()
    ...
    <main id="worker-form">
      ...
      <form id="form-container" onSubmit={formik.handleSubmit}>
        ...
        <section className="dadosProfissionais">
          ...
          <div className="cnpj">
            ...
            <input
              id="cnpj"
              type="text"
              {...register("cpnjProfissional")}
              onChange={formik.handleChange}
              value={formik.values.cnpjProfissional}
            />
        ...
        <section id="servicos">
          ...
          <h3 className="pergunta-label">
            Quais serviços você se sente mais seguro(a) em fazer?
          </h3>
        ...
        <section id="agenda">
          ...
          <div className="horarios">
            ...
            <h3 className="pergunta-label">
              Aceita prestar serviços nos finais de semana?
            </h3>
            ...
            <h3 className="pergunta-label">
              Você está trabalhando de carteira assinada?
            </h3>

            <input
              id="sim-cart-assinada"
              {...register("cartAssinada")}
              type="radio"
              value="Sim"
              onChange={formik.handleChange}
            />
        ...
        <section id="financeiro">
          ...
          <div className="financeiro-servico">
            <h3 className="pergunta-label">
              Como você costuma cobrar pelo serviço?
            </h3>
            ...
            <h3 className="pergunta-label">
              Quanto você costuma cobrar, em média, pelo serviço?
            </h3>
            ...
            <input
              ...
              {...register("precoMedio")}
              onChange={formik.handleChange}
              value={formik.values.precoMedio}
            />
        ...
        <section id="experiencia-profissional">
          ...
          <section className="informe">
            <h3 className="pergunta-label">
              {" "}
              Informe pelo menos um contato de referência profissional:
            </h3>
            ...
            <h3>
              <Label
                id="certificado"
                label="Possui certifições complementares? Quais? (opcional)"
              />
            </h3>
            <input
              id="certificado"
              ...
              onChange={formik.handleChange}
              value={formik.values.certificacoes}
            />
          </section>
        </section>
