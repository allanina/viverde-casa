...
export default function CompanyForm() {
  ...
  const workerSchema = Yup.object().shape({
    ...
    qtdColaboradores: Yup.string().required(
      "Quantidade de colaboradores obrigatório."
    ),
    ...
    indicacao: Yup.string().max(40, "quantidade máxima de caracteres atingida"),
    ...
    comentarioSolicitacao: Yup.string().min(10, "Nó mínimo 10 caracteres"),

    // Vínculos, questôes éticas e morais

    CampanhasPoliticas: Yup.string().required("Campo obrigatório"),

    CargoPublico: Yup.string().required("Campo obrigatório"),

    VinculoPolitico: Yup.string(),

    escandalo: Yup.string().required("Campo obrigatório"),

    escandaloAssedio: Yup.string().required("Campo obrigatório"),

    PlanoImpacto: Yup.string().required("Campo obrigatório"),

    ImpactoPositivo: Yup.string().required("Campo obrigatório"),

    ImpactoSocial: Yup.string().required("Campo obrigatório"),

    PoliticaDiversidade: Yup.string().required("Campo obrigatório"),
    ...
    <main id="company-form">
      ...
      <form id="form-container" onSubmit={formik.handleSubmit}>
            ...
            <div className="right">
              ...
              >
                ...
                <p className="error-message">
                  {formik.errors.qtdColaboradores}
                </p>
              </div>
              ...
              <input
                type="text"
                id="endereco-eletronico"
                {...register("enderecoEletronico")}
                onChange={formik.handleChange}
                value={formik.values.enderecoEletronico}
              />
              <p className="error-message">
                {formik.errors?.enderecoEletronico}
              </p>
            </div>
          </section>
        ...
        <section className="dadosRepresentante">
          ...
          <section className="left-right">
            ...
            <div className="right">
              ...
              />
              <p className="error-message">
                {formik.errors.telefoneRepresentante}
              </p>
            </div>
          </section>
          ...
          <input
            type="text"
            id="cargo-empresa"
            {...register("cargoEmpresa")}
            onChange={formik.handleChange}
            value={formik.values.cargoEmpresa}
          />
        ...
        <section className="informacaoSolicitacao">
          ...
          <p className="caracteres">
            Queremos entender um pouco mais da necessidade de sua empresa
          </p>
            ...
            <ul className="items">
              <li>
                <input
                  ...
                  value="Parceria comercial"
                  {...register("servicoInfo")}
                  onChange={formik.handleChange}
                />
                <LabelServ
                  id="parceria-comercial"
                  label="Parceria comercial (Quero fazer parte do programa de descontos e conquistar novos clientes)"
                />
              </li>
              <li>
                <input
                ...
                <LabelServ
                  id="intermediacao"
                  label="Intermediação de mão de obra (Busco contratação de mão de obra qualificada para reforma e construção)"
                />
              </li>
              <li>
                <input
                  ...
                  value="Qualificação profissional"
                  {...register("servicoInfo")}
                  onChange={formik.handleChange}
                />
                <LabelServ
                  id="qualificacao-profissional"
                  label="Qualificação profissional (Quero contratar um pacote de qualificação de mão de obra para minha equipe) "
                />
              </li>
              <li>
                <input
                  type="checkbox"
                  id="apoio-acoes"
                  value="Apoio a ações ESG"
                  {...register("servicoInfo")}
                  onChange={formik.handleChange}
                />
                <LabelServ
                  id="apoio-acoes"
                  label="Apoio a ações ESG (Quero investir em ações de impacto social e ambiental com a Viverde Casa) "
                />
              </li>
            </ul>
          ...
          <input
            ...
            onChange={formik.handleChange}
            value={formik.values.servicoOutro}
          />

          <p className="questions">
            Que iniciativa de impacto gostaria de apoiar?
          </p>
          <div
            id="checklistServicos"
            className={`dropdown-check-list ${
            ...
            <ul className="items">
              <li>
                <input
                  type="checkbox"
                  id="viverde-capacita"
                  value="viverdeCapacita"
                  {...register("iniciativaInfo")}
                  onChange={formik.handleChange}
                />
                <LabelServ
                  id="viverde-capacita"
                  label="Viverde Capacita (Programa de qualificação profissional)"
                />
              </li>
              <li>
                <input
                ...
                <LabelServ
                  id="viverde-athis"
                  label="Viverde ATHIS (Programa de melhorias habitacionais de interesse social)"
                />
              </li>
              <li>
                <input
                ...
                <LabelServ
                  id="viverde-hub"
                  label="Viverde HUB (Programa de incentivo a pesquisa, desenvolvimento e inovação)"
                />
              </li>
            </ul>
          ...
          <textarea
            id="comentarioSolicitacao"
            {...register("comentarioSolicitacao")}
            onChange={formik.handleChange}
            value={formik.values.comentarioSolicitacao}
          />
        ...
        <section className="Veiculos-Que">
          ...
          <p className="caracteres">
            Gostaríamos de conhecer um pouco mais sobre você e os representantes
            da sua organização.
          </p>
          <p className="questions">
            Sua empresa ou algum de seus representantes tem ou teve envolvimento
            com campanhas políticas ou partidárias nos últimos 20 anos?
          </p>

          <div className="inputs-escolha">
            <input
              id="CampanhasSim"
              {...register("CampanhasPoliticas")}
              type="radio"
              value="Sim"
              onChange={formik.handleChange}
            />
          ...
          <p className="questions">
            Você ou algum outro dirigente da empresa tem ou teve algum parente
            de até 2º ocupando cargo publico nos últimos 20 anos?
          </p>

          <div className="inputs-escolha">
            <input
              id="CargoSim"
              {...register("CargoPublico")}
              type="radio"
              value="Sim"
              onChange={formik.handleChange}
            />
          ...
          <Label
            id="VinculoPolitico"
            label="Se a sua resposta para as perguntas anteriores for sim; 
          ...
          <input
            id="VinculoPolitico"
            type="text"
            {...register("VinculoPolitico")}
            onChange={formik.handleChange}
            value={formik.values.VinculoPolitico}
          />

          <p className="questions">
            Sua empresa ou algum de seus representantes tem ou teve envolvimento
            em algum escândalo envolvendo questões de trabalho escravo desde a
            sua fundação?
          </p>
          <div className="inputs-escolha">
            <input
          ...
          <p className="questions">
            Sua empresa ou algum de seus representantes tem ou teve envolvimento
            em algum escândalo envolvendo questões de assédio físico ou moral
            desde a sua fundação?
          </p>
          <div className="inputs-escolha">
            <input
              id="AssedioSim"
              {...register("escandaloAssedio")}
              type="radio"
              value="Sim"
              onChange={formik.handleChange}
            />
          ...
          <p className="questions">
            Sua empresa ou organização já possui um plano de impacto positivo,
            com parâmetros claros e definidos,que esteja em prática? 
          </p>
          <div className="inputs-escolha">
            <input
              id="PlanoSim"
              {...register("PlanoImpacto")}
              type="radio"
              value="Sim"
              onChange={formik.handleChange}
            />
          ...
          <Label
            id="ImpactoPositivo"
            label="O que você enxerga de possível melhoria para ampliar 
          ...
          <input
            type="text"
            id="ImpactoPositivo"
            {...register("ImpactoPositivo")}
            onChange={formik.handleChange}
            value={formik.values.ImpactoPositivo}
          />
          <p className="error-message">{formik.errors.ImpactoPositivo}</p>

          <Label
            id="ImpactoSocial"
            label="Quais os setores da sua organização que investem em 
                      impacto social ou ambiental positivo?"
          />
          <input
            type="text"
            id="ImpactoSocial"
            {...register("ImpactoSocial")}
            onChange={formik.handleChange}
            value={formik.values.ImpactoSocial}
          />
          <p className="error-message">{formik.errors.ImpactoSocial}</p>

          <p className="questions">
            Sua organização já possui uma política de diversidade implantada em
            algum setor?
          </p>
          <div className="inputs-escolha">
            <input
              id="DiversidadeSim"
              {...register("PoliticaDiversidade")}
              type="radio"
              value="Sim"
              onChange={formik.handleChange}
            />
